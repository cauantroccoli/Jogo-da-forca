const palavras = ['amarelo', 'abacate', 'carro', 'ave', 'avião', 'avó', 'balão', 'óculos', 'casa', 'rato', 'navio', 'ambulância'];
const palavraSecreta = palavras[Math.floor(Math.random() * palavras.length)]; // length -> retorna tamanho de string ou array 
const letrasErradas = [];
